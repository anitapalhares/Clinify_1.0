...
(function () {
    ...
    var menus = {
        estudante: [['home_e.html', 'Início'], ['casos.html', 'Simulação clínica'], ['estudos.html', 'Estudos'], ['desempenho.html', 'Desempenho'], ['perfil.html', 'Meu perfil']],
        professor: [['home_p.html', 'Início'], ['turmas.html', 'Minhas turmas'], ['alunos.html', 'Alunos'], ['estudo.html', 'Área de estudo'], ['desempenho.html', 'Desempenho'], ['casos.html', 'Salas de simulação'], ['perfil.html', 'Meu perfil']],
        administrador: [['home_a.html', 'Início'], ['professores.html', 'Professores'], ['perfil.html', 'Meu perfil']]
    };
