...
(function () {
    ...
    function renderizar() {
        ...
        alvo.innerHTML = '<div class="jornada-cabecalho"><div><p class="jornada-selo">Sua jornada Clinify</p><h2>Cada prática conta.</h2><p>Transforme sua dedicação em novas conquistas.</p></div><span class="jornada-nivel">Nível ' + r.nivel + '</span></div>' +
            ...
            '<p class="jornada-regras">+100 XP por caso concluído · +150 XP por módulo. Cada caso ou sala e cada módulo contam uma vez; revisões não repetem XP. As conquistas reconhecem sua prática, sem representar habilitação clínica.</p>' +
            '<h3>Sua coleção de ícones</h3><p>Escolha um ícone desbloqueado para usar no perfil.</p><div class="jornada-colecao">' +
